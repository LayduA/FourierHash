...
\draw[thick]  (\scl*5cm, 10.5*\scl) --  (\scl*5, 9.5*\scl);
\draw[thick]  (\scl*5cm, 8*\scl) --  (\scl*5, 9*\scl);
\draw[thick,->]  (\scl*5cm, 9.5*\scl) --  (\firstthird-2.25*\scl, 9.5*\scl);
\draw[thick,->]  (\scl*5cm, 9*\scl) --  (\firstthird-2.25*\scl, 9*\scl);

\draw[thick]  (\scl*3cm, 3.5*\scl) --  (\scl*5, 3.5*\scl);
\draw[thick]  (\scl*3cm, 1*\scl) --  (\scl*5, 1*\scl);
\draw[thick]  (\scl*5cm, 3.5*\scl) --  (\scl*5, 2.5*\scl);
\draw[thick]  (\scl*5cm, 1*\scl) --  (\scl*5, 2*\scl);
\draw[thick,->]  (\scl*5cm, 2.5*\scl) --  (\firstthird-2.25*\scl, 2.5*\scl);
\draw[thick,->]  (\scl*5cm, 2*\scl) --  (\firstthird-2.25*\scl, 2*\scl);
...
\draw[thick] (\firstthird + 4.25*\scl, \scl * 2cm) -- (\firstthird + 4.25*\scl, \scl * 3.25cm);
\draw[thick,->] (\firstthird + 4.25*\scl, \scl * 3.25cm) -- (7*2.5*\scl, \scl * 3.25cm);
