...
Humans tend to perform better at identifying symmetrical objects [ref]. Therefore, we would like our fingerprints to be symmetric. In order to determine the type of symmetry to apply, we compute $h \mod p_{\text{symmetry}}$. The different types of symmetries are detailed [SOMEWHERE]. \Cref{fig:symms} show the result of applying this process to our 2 hashes. 
\begin{center}
\begin{figure}
    \centering
