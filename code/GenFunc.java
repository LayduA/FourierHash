...
public class GenFunc {
    ...
    public GenFunc(Blockies b) {
        this(TYPES.CONST, b);
    }

    public GenFunc(TYPES t, Blockies b, GenFunc... args) {
        type = t;
    ...
    public static GenFunc randomFunc(String seed, int depth) {
        Blockies b = new Blockies(seed);

        return randomFunc(depth, b);
    }

    public static GenFunc randomFunc(int depth, Blockies b) {
        if (depth == 0)
